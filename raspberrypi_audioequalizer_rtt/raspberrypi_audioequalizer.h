...
typedef struct {
   ...
   */
  uint8_T ALSAAudioPlayback_p1[11];
...
struct Parameters_raspberrypi_audioequ_ {
  ...
  real32_T SmoothCoefficientsLeakyIntegrat;/* Mask Parameter: SmoothCoefficientsLeakyIntegrat
                                            * Referenced by: '<S8>/b0'
                                            */
  real32_T SmoothCoefficientsLeakyIntegr_c;/* Mask Parameter: SmoothCoefficientsLeakyIntegr_c
                                            * Referenced by: '<S10>/b0'
                                            */
  real32_T SmoothCoefficientsLeakyIntegr_k;/* Mask Parameter: SmoothCoefficientsLeakyIntegr_k
