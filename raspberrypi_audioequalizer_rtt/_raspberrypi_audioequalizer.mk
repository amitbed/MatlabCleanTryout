...
HEADER_FILES        := $(call FORMAT_PATH,./ext_svr.h) $(call FORMAT_PATH,./ext_work.h) $(call FORMAT_PATH,./updown.h) $(call FORMAT_PATH,./rtiostream_utils.h) $(call FORMAT_PATH,./raspberrypi_audioequalizer.h) $(call FORMAT_PATH,./rtGetInf.h) $(call FORMAT_PATH,./rtGetNaN.h) $(call FORMAT_PATH,./rt_nonfinite.h)
LIBRARY_FILES       := 
